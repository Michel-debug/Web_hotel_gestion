...
<body>
  ...
  <form action="update.php" method="post" class="table_form">
    <div >
        ...
        <input type="checkbox" name="fenetre"  value="\0">eteindre
        <input type="checkbox" name="fenetre"  value="1">ouvrir
    </div>
    <div >
    ...
    <div >
        ...
        <input type="range" name="temperature" id="temperature"  min="19" max="30">
    </div>
    <div >
